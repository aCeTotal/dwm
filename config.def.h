...
static const char *psuwebcmd[]  = 		{ "psuwin", NULL };
static const char *psuwincmd[]  = 		{ "psuwin", NULL };
static const char *kgravcmd[]  = 		{ "brave https://www.gravekoordinering.no/kgrav", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F3,          spawn,                  {.v = psuwincmd } },
	{ MODKEY,                       XK_F4,     		spawn,                  {.v = kgravcmd } },
	{ MODKEY,                       XK_F5,     		spawn,                  {.v = teamscmd } },
